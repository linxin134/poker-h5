...
const suitNames: Record<Suit, "spades" | "hearts" | "diamonds" | "clubs"> = {
  "♠": "spades",
  "♥": "hearts",
  "♦": "diamonds",
  "♣": "clubs"
...
export function PlayingCard({ card, hidden = false, delay = 0, small = false }: { card?: Card; hidden?: boolean; delay?: number; small?: boolean }) {
  ...
  const suitName = suit ? suitNames[suit] : undefined;
  ...
  return (
    <motion.div
      ...
      initial={{ opacity: 0, y: hidden ? -22 : -5, rotateY: hidden ? 0 : 88, scale: hidden ? .92 : .96 }}
